...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        try:
            logging.info("exporting daat from mongodb to feature store")
            ...
            logging.info("Data exported successfully to feature store")
            return dataframe
        except Exception as e:
            raise SensorException(e,sys)
    ...
    def split_data_as_train_test(self,dataframe:DataFrame)->None:
        try:
            ...
            logging.info("performed ttrain test split on data frame")
